...
def retrieve_incomes(movie_id, full_week=False, use_cumes=False): 
    ...
    def parse_incomes(page, full_week, use_cumes):
        ...
        if use_cumes:
            ...
            if full_week:
                ...
                pattern1 = r'<td align="center"><font size="2">([0-9\-]*?)</font></td><td align="right"><font size="2">\$([0-9,]*?)</font></td>'
                incomes =  [g[1] for g in re.findall(pattern1, page)]
    ...
    if full_week:
        ...
        url = url_template % ("weekly", movie_id)#changed this to 'weekly' from 'weekend'. Boy, did this line send me through some trouble-shooting hoops.
